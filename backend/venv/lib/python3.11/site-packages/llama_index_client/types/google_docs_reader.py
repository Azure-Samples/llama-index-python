...
class GoogleDocsReader(pydantic.BaseModel):
    ...
    split_on_heading_level: typing.Optional[int] = pydantic.Field(
        description="If set the document will be split on the specified heading level."
    )
    include_toc: typing.Optional[bool] = pydantic.Field(description="Include table of contents elements.")
