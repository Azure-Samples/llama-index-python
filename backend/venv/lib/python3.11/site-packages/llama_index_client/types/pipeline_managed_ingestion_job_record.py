...
class PipelineManagedIngestionJobRecord(pydantic.BaseModel):
    ...
    data_source_ingestion_job_ids: typing.Optional[typing.List[str]] = pydantic.Field(
        description="The IDs for the DataSourceManagedIngestionJobRecords this execution ran against."
    )
    raw_file_ingestion_job_ids: typing.Optional[typing.List[str]] = pydantic.Field(
        description="The IDs for the RawFileManagedIngestionJobRecords this execution ran against."
    )
