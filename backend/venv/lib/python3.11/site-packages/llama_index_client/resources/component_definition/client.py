...
class ComponentDefinitionClient:
    ...
    def get_all_transformation_definitions(self) -> typing.List[ConfigurableTransformationDefinition]:
        ...
        client.component_definition.get_all_transformation_definitions()
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", "api/component_definition/configurable_transformation"
            ),
    ...
    def get_all_data_source_definitions(self) -> typing.List[DataSourceDefinition]:
        ...
        client.component_definition.get_all_data_source_definitions()
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/component_definition/data_source"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
    ...
    def get_all_data_sink_definitions(self) -> typing.List[DataSinkDefinition]:
        ...
        client.component_definition.get_all_data_sink_definitions()
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/component_definition/data_sink"),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
...
class AsyncComponentDefinitionClient:
    ...
    async def get_all_transformation_definitions(self) -> typing.List[ConfigurableTransformationDefinition]:
        ...
        await client.component_definition.get_all_transformation_definitions()
        """
    ...
    async def get_all_data_source_definitions(self) -> typing.List[DataSourceDefinition]:
        ...
        await client.component_definition.get_all_data_source_definitions()
        """
        _response = await self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/component_definition/data_source"),
    ...
    async def get_all_data_sink_definitions(self) -> typing.List[DataSinkDefinition]:
        ...
        await client.component_definition.get_all_data_sink_definitions()
        """
        _response = await self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/component_definition/data_sink"),
